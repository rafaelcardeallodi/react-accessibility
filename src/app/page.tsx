...
export default function Home() {
  return (
    <>
      <header className="flex items-center justify-between max-w-[1064px] w-full m-auto py-6 px-5">
        <Image src={LogoImg} width={286 / 2} alt="Blog da Rocketseat" />

        <nav>
          <a
            href="https://github.com/rafaelcardeallodi.png"
      ...
      <main>
        <article className="content max-w-[776px] w-full m-auto py-6 px-5">
          <header>
      ...
      <footer className="flex items-center justify-between max-w-[1064px] w-full m-auto py-6 px-5">
        <Modal
          title="Termos de Uso"
          description="Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Quisquam voluptatum, quibusdam, quia, quae voluptates voluptatem
                consequuntur quod voluptatibus quos doloribus quidem. Quisquam
                voluptatum, quibusdam, quia, quae voluptates voluptatem
                consequuntur quod voluptatibus quos doloribus quidem."
        >
          Termos de Uso
        </Modal>
      </footer>
